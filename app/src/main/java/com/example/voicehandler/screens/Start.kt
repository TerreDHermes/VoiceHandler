...
//                }
                Button(
                    ...
                    modifier = Modifier
                        .width(200.dp)
                        //.height(50.dp) // Установите желаемую высоту кнопки
                        .padding(vertical = 8.dp)
                        .background(
                            shape = CircleShape, // Установите форму овала
                            color = Color.Blue // Установите желаемый цвет кнопки
                        ),
                    ...
                    Text(
                        ...
                        modifier = Modifier
                            .padding(8.dp) ,// Отступы для текста внутри кнопки
                            //.fillMaxSize(), // Заполнить максимальное доступное пространство
